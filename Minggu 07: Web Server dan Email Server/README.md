...
7. Lakukan pengecekan kesesuaian tanggal system dengan perintah
   ...
   ```
    ...
    <p><strong>Gambar 1:</strong> timedatectl</p>
    </div>
...
3. Melakukan test ke web browser
    ...
    <p><strong>Gambar 2:</strong> Apache 2</p>
    </div>
...
9. Mengkonﬁgurasi PHP-FM pada ﬁle konﬁgurasi Apache
...
10. Melakukan test validasi terhadap PHP-FM dengan membuat ﬁle info.php di root document
    ```bash
...
11. Test browser
    ...
    <p><strong>Gambar 3:</strong> PHP</p>
    </div>
...
<p><strong>Gambar 4:</strong> netstat</p>
</div>

<div align="center">
<img src="./assets/5.PNG">
<p><strong>Gambar 5:</strong> telnet</p>
</div>
